  ...
  <tr>
    <td>
      <ul>
        ...
        <li>🌱 Exploring AI/ML, Deep Learning, LLMs, and Generative AI</li>
        <li>📜 Google IT Professional Certified</li>
        <li>💻 Web Developer Intern</li>
        <li>🚀 Integrating Generative AI into multiple projects</li>
        <li>✨ Passionate about innovation, problem-solving & impactful tech solutions</li>
      </ul>
    </td>
    <td>
